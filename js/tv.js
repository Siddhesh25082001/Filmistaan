const API_URL = "https://api.themoviedb.org/3/discover/tv?sort_by=popularity.desc&api_key=04c35731a5ee918f014970082a0088b1&page=1";
...
function showMovies(movies){
    ...
    movies.forEach(movie => {
        ...
        movieEL.innerHTML = `
            <img src="${getPosterpath(poster_path)}" alt="${name}">
